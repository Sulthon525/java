...
public class Admin extends javax.swing.JFrame {
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        try {
            ...
            String sql = "SELECT * FROM siswa WHERE NIS = '"+txcari.getText()+"' OR nama = '"+txcari.getText()+"'";
            ...
            if (rs.next()) {
                ...
                jnsklmn.setSelectedItem(rs.getString(4));
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        try{
            java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
            String sql = "UPDATE siswa SET nis = '"+nim.getText()+
                    "', nama ='"+nama.getText()+
                    "', kelas ='"+kls.getText()+
                    "', jns_klmn = '"+jnsklmn.getSelectedItem()+
                    "', no_telp = '"+notelp.getText()+"' WHERE nama ='"+txcari.getText()+"' OR nis = '"+txcari.getText()+"'";
            System.out.println(sql);
            java.sql.PreparedStatement stm = con.prepareStatement(sql);
            stm.executeUpdate();
    ...
    private void hpsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hpsActionPerformed
        try {
            java.sql.Connection con = (java.sql.Connection) Home.Koneksi.getKoneksi();
            String sql = "DELETE FROM siswa WHERE nis ='"+nim.getText()+"'";
            java.sql.PreparedStatement stm = con.prepareStatement(sql);
            stm.executeUpdate();
